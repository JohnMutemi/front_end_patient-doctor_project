    ...
    <div className="about-container">
      <main className="about-main">
        <section className="about-section">
          ...
          <p>
            MediCare+ is your comprehensive solution for managing doctor-patient
          ...
          <ul>
            ...
            <li>
              Role-based access control for doctors, patients, and
              administrators.
            </li>
          ...
          <p>
            With MediCare+, managing your healthcare appointments has never been
            easier.
          </p>
          <p>
